<div class=" py-16 lg:py-24">
    <div class="relative mx-auto max-w-7xl px-6 lg:px-8 ">
      <div class="relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 py-24 px-8 shadow-2xl lg:grid lg:grid-cols-2 lg:gap-x-8 lg:px-16">
        <div class="absolute inset-0 opacity-90 mix-blend-multiply saturate-0 filter">
        ...
        <div class="relative lg:col-span-1 ">
          <img class="h-12 w-auto" src="/rocket-logo.svg" alt="">
          <blockquote class="mt-6 text-white">
            ...
            <footer class="mt-6">
              <p class="flex flex-col font-medium">
                <span>Himanshu Narayan</span>
                <span>CEO, Rocket Growth Tech.</span>
              </p>
            </footer>
          </blockquote>
        </div>
